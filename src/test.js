...
import { processMessage, } from "./message_processor";
...
class MockDatabaseClient extends DatabaseClient {
    ...
    async classifyMessage(_embedding, _campaignHint) {
    ...
    async getDuplicateRank(_senderHash, _politicianId, _campaignId) {
